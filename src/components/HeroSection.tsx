  ...
  return (
    <>
      ...
      <div className='sm:px-14 px-5 sticky top-8 z-50'>
        <div className='flex mx-auto max-w-sm sm:max-w-3xl sm:justify-between justify-center px-3 sm:px-5 items-center glass-effect-dark shadow-xl backdrop-blur-3xl border-purple-500/30 py-2 rounded-full transition-all duration-300 hover:border-purple-500/50 hover:shadow-2xl hover:shadow-purple-500/20'>
      ...
      <div className='flex flex-col sm:px-14 px-5 justify-center items-center mb-12 pt-2 mt-16 sm:mt-20 relative z-10'>
        ...
        <div className='text-center text-white animate-fade-in-up font-bold font-sans mt-4 text-xl md:text-3xl lg:text-[38px]'>
          ...
          <p className='text-gray-300 font-normal text-sm md:text-base lg:text-lg max-w-3xl mx-auto leading-relaxed px-4'>
            I’m passionate about creating applications that deliver real results, combining scalable architecture with clean, intuitive, and high-performance UIs.
          </p>
        </div>
        ...
        <ScrollReveal animation='animate-expand-horizontally'>
          <div className='flex justify-items-center mt-4 gap-3 sm:gap-4 relative mb-6'>
            <a href="#" target='_blank' className='cursor-pointer group'>
